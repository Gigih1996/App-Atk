<div class="modal fade" id="EditDepartementModal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="DepartementFormUpdate" autocomplete="off">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="NameEditDepartement" name="name">
            ...
            <div class="modal-footer mt-5">
                <button type="button" class="btn btn-md btn-primary" id="submit_edit" onclick="UpdateDepartement()">
